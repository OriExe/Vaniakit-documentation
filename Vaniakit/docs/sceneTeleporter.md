...
## How to use
**Note:** Before you follow this tutorial make sure you've set up the [Managers](/Managers) class and the [FadeInManager](/fadeInManager) which should be a child in the managers class. 
